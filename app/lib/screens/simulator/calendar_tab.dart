...
class _CalendarTabState extends State<CalendarTab>
  ...
  Widget build(BuildContext context) {
    ...
    // Summary counts
    final overdueCount = _allItems
        .where((d) => d.status == DeadlineStatus.overdue)
        .length;
    final urgentCount = _allItems
        .where((d) => d.status == DeadlineStatus.urgent)
        .length;
    final warningCount = _allItems
        .where((d) => d.status == DeadlineStatus.warning)
        .length;
    final upcomingCount = _allItems
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(
              label,
              style: AppTextStyles.body(9, color: color.withValues(alpha: 0.8)),
