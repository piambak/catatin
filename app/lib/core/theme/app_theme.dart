...
class AppColors {
  ...
  static Color get brandLight =>
      _dark ? const Color(0xFF232528) : const Color(0xFFFFF3CC);
  ...
  static Color get accentLight =>
      _dark ? const Color(0xFF232528) : const Color(0xFFEAF6FF);
  ...
  static Color get incomeLight =>
      _dark ? const Color(0xFF232528) : const Color(0xFFE6F7EE);
  static Color get incomeBorder =>
      _dark ? const Color(0xFF1B8A4B) : const Color(0xFF9CDDB7);
  static Color get expenseBorder =>
      _dark ? const Color(0xFFD92B2B) : const Color(0xFFF7C1C1);
  static const expense = Color(0xFFD92B2B);
  static Color get expenseLight =>
      _dark ? const Color(0xFF232528) : const Color(0xFFFCEBEB);
  static const warning = Color(0xFFB07D2A);
  static Color get warningLight =>
      _dark ? const Color(0xFF232528) : const Color(0xFFFAEEDA);
  static Color get warningBorder =>
      _dark ? const Color(0xFFB07D2A) : const Color(0xFFFAC775);
  static const navy = Color(0xFF009FFD);
  static Color get navyLight =>
      _dark ? const Color(0xFF232528) : const Color(0xFFEAF6FF);
  static Color get navyBorder =>
      _dark ? const Color(0xFF185FA5) : const Color(0xFFB3E0FE);

  // ── Badge foreground colors (adapt for dark mode) ──────────
  static Color get incomeBadgeFg =>
      _dark ? const Color(0xFF7AE8A6) : const Color(0xFF27500A);
  static Color get expenseBadgeFg =>
      _dark ? const Color(0xFFFF9A9A) : const Color(0xFF791F1F);
  static Color get warningBadgeFg =>
      _dark ? const Color(0xFFFFCC70) : const Color(0xFF633806);
  static Color get navyBadgeFg =>
      _dark ? const Color(0xFF7DCFFF) : const Color(0xFF0C447C);

  // ── Backgrounds — switch between light and dark ───────────
  static Color get bgPage =>
  ...
  static Color get bgSecondary =>
      _dark ? const Color(0xFF363A3F) : const Color(0xFFEAF6FF);

  // ── Neutral text / border — switch ────────────────────────
  static Color get stone50 =>
      _dark ? const Color(0xFF2D3035) : const Color(0xFFF4F9FF);
  static Color get stone100 =>
      _dark ? const Color(0xFF3A3F47) : const Color(0xFFE8F2FF);
  static Color get stone200 =>
      _dark ? const Color(0xFF454B55) : const Color(0xFFCDD8E8);
  static Color get stone300 =>
      _dark ? const Color(0xFF5A6270) : const Color(0xFFAAB8CC);
  static Color get stone400 =>
      _dark ? const Color(0xFF7A8494) : const Color(0xFF8898AA);
  static Color get stone500 =>
      _dark ? const Color(0xFF9AAABB) : const Color(0xFF667788);
  static Color get stone600 =>
      _dark ? const Color(0xFFBBCCDD) : const Color(0xFF445566);
  static Color get stone700 =>
      _dark ? const Color(0xFFCCDDEE) : const Color(0xFF334455);
  static Color get stone800 =>
      _dark ? const Color(0xFFDDEEFF) : const Color(0xFF1E2D3D);
  static Color get stone900 =>
      _dark ? const Color(0xFFEAF6FF) : const Color(0xFF0D1B2A);
}
...
class AppTheme {
  ...
  static ThemeData _build(bool isDark) => ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      shape: Border(
        bottom: BorderSide(
          color: isDark ? const Color(0xFF454B55) : const Color(0xFFCDD8E8),
          width: 0.5,
        ),
      ),
    ),
