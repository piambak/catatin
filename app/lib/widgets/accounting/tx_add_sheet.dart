          ...
          children: [
            if (prefix != null) ...[
              Padding(
                ...
                child: Text(prefix!, style: Typo.sans(13, color: DS.faint)),
              ),
      ...
      Container(
        ...
        child: Row(
          children: [
            ...
            Icon(Icons.calendar_today_outlined, size: 14, color: DS.faint),
          ],
        ),
      ),
    ],
...
class _SheetDropdownState<T> extends State<_SheetDropdown<T>> {
                            ...
                            children: [
                              Expanded(
                                child: Text(
                                  ...
                                  style: Typo.sans(
                                    13,
                                    color: selected ? DS.brand : DS.ink,
                                    weight: selected
                                        ? FontWeight.w500
                                        : FontWeight.w400,
                                  ),
  ...
  Widget build(BuildContext context) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(widget.label, style: Typo.sans(11, color: DS.faint)),
      const SizedBox(height: 4),
              ...
              children: [
                Expanded(
                  child: Text(
                    ...
                    style: Typo.sans(
                      13,
                      color: widget.value != null ? DS.ink : DS.border,
                    ),
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Icon(Icons.close_rounded, size: 16, color: DS.muted),
                  ),
                ),
              ],
            ),
